package aseguramientoBDD.runner;
...
@CucumberOptions(
		features = "src/test/resources/feature/Remoto_GestiondePlanta.feature"
//        features =  "src/test/resources/feature/" //Se ejecutaran todos los archivos features, por orden alfabetico segun especificado en el campo Feature.
        ...
        , glue = {"aseguramientoBDD.tests"} //Ubicación package de la clase steps
