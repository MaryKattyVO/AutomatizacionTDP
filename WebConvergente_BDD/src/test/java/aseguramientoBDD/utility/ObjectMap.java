...
package aseguramientoBDD.utility;
	...
	public class ObjectMap {
		...
		public static By getLocator(String objPropDesc) throws Exception{
			...
			String locatorType;
			String locatorValue;
			boolean hasLocatorType = objPropDesc.contains("|"); //ubicame este | en todo el string xpath|nombredelxpath
			boolean hasLocatorType2 = objPropDesc.startsWith("|"); // | tipo_del_elementocuerpo_del_elemento
			
			if (hasLocatorType){
				locatorType = objPropDesc.substring(0,objPropDesc.indexOf("|"));
